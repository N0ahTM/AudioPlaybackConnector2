# Builds a local Release x64 MSIX (unsigned) and copies release assets into ./dist/v0.6.2/
# For signed GitHub releases, push tag v0.6.2 and use the Release workflow instead.
