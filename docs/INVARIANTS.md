...
Host resource-authorization mutex protects pressure sequence and the published ResourceStatusSnapshot. Convert policy/pressure once on publication; readers copy the same value. Pure policy has no host retry/scheduling dependencies.
